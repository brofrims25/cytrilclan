...
import com.cytril.cytrilclan.integration.VaultHook;
...
public class CytrilClan extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new com.cytril.cytrilclan.listeners.ClanPvpListener(this), this);
        getServer().getPluginManager().registerEvents(new com.cytril.cytrilclan.listeners.ClanChatListener(this), this);
        ...
        if (configManager.isEconomyEnabled()) {
            if (vaultHook.isAvailable()) {
                getLogger().info("Hooked into Vault for clan creation costs.");
            } else {
                getLogger().warning("features.economy is true but Vault (or an economy plugin) isn't installed - clan creation will be free.");
            }
        }
